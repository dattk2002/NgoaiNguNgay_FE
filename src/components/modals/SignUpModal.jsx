...
const EyeOffIcon = () => (
  <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7 .529-1.68 1.54-3.197 2.79-4.375M9 4.305A11.95 11.95 0 0112 4c4.478 0 8.268 2.943 9.542 7a10.054 10.054 0 01-1.875 3.825M12 15a3 3 0 110-6 3 3 0 010 6z" />
...
function SignUpModal({ isOpen, onClose, onSwitchToLogin, onSignUpSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to ConfirmEmail modal
      onSignUpSuccess(email);
      onClose();
    } catch (error) {
      console.error("Sign Up Failed:", error);
      setError(error.response?.data?.errorMessage || "Đăng ký thất bại. Vui lòng thử lại.");
    }
  };
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-black text-2xl font-semibold text-center mb-3">Create Account</h2>
