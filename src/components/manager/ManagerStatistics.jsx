    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Thống kê giao dịch & Doanh thu hệ thống</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-blue-100 text-sm font-medium">Tổng giao dịch</p>
                <p className="text-3xl font-bold">{statisticsData.totalTransactionCount?.toLocaleString()}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{formatPriceWithCommas(statisticsData.totalTransactionAmount)}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-100 text-sm font-medium">Thành công</p>
                <p className="text-3xl font-bold">{statisticsData.countByStatus?.Success?.toLocaleString() || 0}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-orange-100 text-sm font-medium">Đang chờ</p>
                <p className="text-3xl font-bold">{statisticsData.countByStatus?.Pending?.toLocaleString() || 0}</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{formatPriceWithCommas(systemRevenueData.totalRevenue)}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-teal-500 to-teal-600 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-teal-100 text-sm font-medium">Tổng phí dịch vụ</p>
                <p className="text-3xl font-bold">{formatPriceWithCommas(systemRevenueData.totalFees)}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-pink-500 to-pink-600 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-pink-100 text-sm font-medium">Tổng hoa hồng</p>
                <p className="text-3xl font-bold">{formatPriceWithCommas(systemRevenueData.totalCommission)}</p>
              </div>
          ...
          <div className="bg-gradient-to-r from-cyan-500 to-cyan-600 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-cyan-100 text-sm font-medium">Số dư ví hệ thống</p>
                <p className="text-3xl font-bold">{formatPriceWithCommas(systemRevenueData.systemWalletBalance)}</p>
              </div>
              ...
              <div key={type} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{getTransactionTypeDescription(type)}</p>
                  </div>
                </div>
              ...
              <div key={status} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{getTransactionStatusDescription(status)}</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-gray-900">{count.toLocaleString()}</p>
            ...
            {systemRevenueData.revenueByType && Object.entries(systemRevenueData.revenueByType).map(([type, amount]) => (
              <div key={type} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">{type}</p>
                    <p className="text-sm text-gray-500">Loại doanh thu</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-gray-900">{formatPriceWithCommas(amount)}</p>
                </div>
              </div>
            ))}
          </div>
