    ...
    return (
        <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        {displayDates.fromDate && (
                            <p className="text-sm text-gray-500 mt-1">Đã chọn: {displayDates.fromDate}</p>
                        )}
                    </div>
                    <div>
                        ...
                        />
                        {displayDates.toDate && (
                            <p className="text-sm text-gray-500 mt-1">Đã chọn: {displayDates.toDate}</p>
                        )}
                    </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-xl font-semibold text-gray-900">{formatCurrency(transactionData.totalDepositAmount)}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-xl font-semibold text-gray-900">{formatCurrency(transactionData.totalWithdrawalAmount)}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-xl font-semibold text-gray-900">{formatCurrency(transactionData.totalPaymentAmount)}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-xl font-semibold text-gray-900">{transactionData.totalTransactionCount}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <p className="text-sm font-medium text-gray-600">Tổng hoàn tiền</p>
                            <p className="text-xl font-semibold text-gray-900">{formatCurrency(transactionData.totalRefundAmount)}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-xl font-semibold text-gray-900">{formatCurrency(transactionData.totalCommissionAmount)}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <p className="text-sm font-medium text-gray-600">Tổng phí</p>
                            <p className="text-xl font-semibold text-gray-900">{formatCurrency(transactionData.totalFeeAmount)}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                    <h3 className="text-lg font-medium text-gray-900 mb-4">Số lượng giao dịch theo loại</h3>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                    <h3 className="text-lg font-medium text-gray-900 mb-4">Số tiền giao dịch theo loại</h3>
                    <div className="space-y-3">
                        {transactionData.transactionAmountByType && 
                            Object.entries(transactionData.transactionAmountByType).map(([type, amount]) => (
                                <div key={type} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div className="text-sm font-medium text-gray-600">{formatCurrency(amount)}</div>
                                </div>
                            ))
                        }
                    </div>
            ...
            <div className="bg-gradient-to-r from-green-500 to-blue-600 rounded-lg p-6 text-white">
                <div className="flex items-center justify-between">
                    <div>
                        <h3 className="text-lg font-medium mb-2">Tổng quan giao dịch</h3>
                        <p className="text-sm opacity-90">
                            {transactionData.totalTransactionCount} giao dịch trong khoảng thời gian đã chọn
                        </p>
                    </div>
                    <div className="text-right">
                        <div className="text-2xl font-bold">{formatCurrency(transactionData.totalPaymentAmount)}</div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start">
                    ...
                    <div>
                        <h4 className="text-sm font-medium text-blue-900 mb-1">Lưu ý về tổng hợp giao dịch</h4>
