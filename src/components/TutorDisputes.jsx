...
import { FaExclamationTriangle, FaClock, FaCheckCircle, FaTimesCircle, FaEye, FaCalendarAlt, FaUser, FaBook, FaSpinner } from "react-icons/fa";
...
const TutorDisputes = () => {
  ...
  const loadDisputes = async () => {
    try {
      setLoading(true);
      const response = await fetchTutorDisputes(pagination.pageIndex, pagination.pageSize, statusFilter);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Khiếu nại của tôi</h1>
          <p className="text-gray-600 mt-1">Xem và quản lý các khiếu nại liên quan đến bạn</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border">
        {loading ? (
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500">Hiện tại không có khiếu nại nào liên quan đến bạn.</p>
          </div>
        ) : (
