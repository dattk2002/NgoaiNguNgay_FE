        ...
        const walletTxs = normalizedWalletTransactions
          ...
          .map((t, index) => {
            try {
              ...
              // Format description (backend already returns Vietnamese)
              const formattedDescription = formatDescription(t.description || t.transactionType || t.note);
              ...
              <div key={transaction.id} className="p-6 hover:bg-gray-100 transition-colors duration-150">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-semibold text-gray-800 text-base leading-relaxed">{transaction.description}</div>
