...
const OfferDetailModal = ({ offer, onClose }) => {
    ...
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-[1000] p-4">
      <div className="bg-white rounded-lg shadow-xl p-6 sm:p-8 w-full max-w-4xl max-h-[90vh] overflow-y-auto mx-auto relative">
        ...
        <div className="mb-6">
          <h3 className="text-black text-xl font-semibold text-center mb-2">Chi tiết Offer</h3>
          <p className="text-gray-600 text-center text-sm">Offer đến {offer.learner?.fullName || 'Học viên'}</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-3">Thông tin cơ bản</h4>
                 ...
                 <div className="flex justify-between">
                   ...
                   <span className={`px-2 py-1 rounded-full text-xs ${getStatusColor(offer.isExpired ? 'EXPIRED' : 'ACTIVE')}`}>
                     {getStatusText(offer.isExpired)}
                   </span>
                 </div>
                 <div className="flex justify-between">
                   <span className="font-medium text-gray-900">Ngày tạo:</span>
                   <span className="text-gray-600">{formatTutorDate(offer.createdAt)}</span>
                 </div>
                 {offer.updatedAt && (
                   <div className="flex justify-between">
                     <span className="font-medium text-gray-900">Cập nhật lúc:</span>
                     <span className="text-gray-600">{formatTutorDate(offer.updatedAt)}</span>
                   </div>
                 )}
                 {offer.expirationTime && (
                   <div className="flex justify-between">
                     <span className="font-medium text-gray-900">Hết hạn lúc:</span>
                     <span className="text-gray-600">{formatTutorDate(offer.expirationTime)}</span>
                   </div>
                 )}
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-3">Thông tin học viên</h4>
                 ...
                 <div className="flex justify-between">
                   ...
                   <span className="text-gray-600">{offer.learner?.fullName}</span>
                 </div>
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-3">Thông tin bài học</h4>
                             <div className="space-y-2 text-sm">
                 <div className="flex justify-between">
                   <span className="font-medium text-gray-900">Tên bài học:</span>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-3">Thời gian đề xuất</h4>
              <div className="space-y-2">
                   ...
                   <p className="text-gray-500 text-sm">Không có thời gian đề xuất</p>
                 )}
              </div>
            </div>
             ...
             <div className="bg-yellow-50 p-4 rounded-lg">
               <h4 className="font-semibold text-gray-900 mb-3">Thông tin giá</h4>
                               <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    <span className="font-medium text-gray-900">Giá mỗi slot:</span>
                    <span className="text-gray-600">{formatPriceWithCommas(offer.pricePerSlot)} VNĐ</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-gray-900">Thời lượng:</span>
                    <span className="text-gray-600">{offer.durationInMinutes} phút</span>
                  </div>
                </div>
             </div>
